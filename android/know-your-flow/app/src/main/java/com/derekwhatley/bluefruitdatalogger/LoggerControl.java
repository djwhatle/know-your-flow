...
//        });
    ...
    public class SensorDataAdapter extends ArrayAdapter<SensorData> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView showerLength = (TextView) convertView.findViewById(R.id.showerLength);
            TextView usage = (TextView)convertView.findViewById(R.id.usage);
            TextView cost = (TextView)convertView.findViewById(R.id.cost);

            LinearLayout colorBox = (LinearLayout)convertView.findViewById(R.id.colorBox);

            String data = sensorData.value1;

            int time = Integer.parseInt(data.split("/")[0]) / 1000;
            ...
            double usageDbl = Double.parseDouble(data.split("/")[1]);
            double costDbl = usageDbl * 0.00418;

            showerLength.setText(timeStr);
            usage.setText(data.split("/")[1] + "gal");

            DecimalFormat df = new DecimalFormat("#0.0000");
            cost.setText("$" + df.format(costDbl));

            if (usageDbl > 13.0) {
                colorBox.setBackgroundColor(Color.rgb(204, 0, 0));
            } else if (usageDbl > 10.0) {
                colorBox.setBackgroundColor(Color.rgb(255, 204, 0));
            } else {
                colorBox.setBackgroundColor(Color.rgb(0, 200, 7));
            }
